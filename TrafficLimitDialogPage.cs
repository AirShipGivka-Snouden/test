...
public sealed class TrafficLimitDialogPage : Page, IViewFor<TrafficLimitDialogViewModel>, IViewFor, IActivatableView, IComponentConnector
{
	...
	object? IViewFor.ViewModel
	{
		...
		set
		{
			ViewModel = (TrafficLimitDialogViewModel)value;
		}
	}

	public TrafficLimitDialogViewModel? ViewModel { get; set; }

	public TrafficLimitDialogPage(TrafficLimitDialogViewModel viewModel)
	{
	...
	public void InitializeComponent()
	{
		...
		{
			_contentLoaded = true;
			Uri uri = new Uri("ms-appx:///Dialogs/TrafficLimitDialogPage.xaml");
