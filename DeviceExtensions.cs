...
public static class DeviceExtensions
{
	extension(IDevice device)
	{
		public bool TryBindProcessToVpn(bool value)
		{
			...
			{
				VhLogger.Instance.LogError(exception, "Could not bind process to VPN.");
				return false;
			}
		}

		public async Task<bool> TryBindProcessToVpn(bool value, TimeSpan delay, CancellationToken cancellationToken)
		{
			bool result;
			try
			{
