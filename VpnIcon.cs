...
public sealed class VpnIcon : UserControl, IComponentConnector
{
	[GeneratedCode("Microsoft.UI.Xaml.Markup.Compiler", " 3.0.0.2605")]
	private Canvas g5070;
	...
	public void InitializeComponent()
	{
		...
		{
			_contentLoaded = true;
			Uri uri = new Uri("ms-appx:///Controls/Icons/VpnIcon.xaml");
	...
	public void Connect(int connectionId, object target)
	{
		if (connectionId == 2)
		{
			g5070 = CastExtensions.As<Canvas>(target);
		}
		_contentLoaded = true;
	}
