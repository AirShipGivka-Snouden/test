...
public class AsyncStreamDecorator<T>(T sourceStream, bool leaveOpen) : Stream, IDataStream where T : Stream
{
	...
	public virtual bool? DataAvailable
	{
		get
		{
			T sourceStream = SourceStream;
			if (!(sourceStream is IDataStream { DataAvailable: var dataAvailable }))
			{
				if (sourceStream is NetworkStream networkStream)
				{
